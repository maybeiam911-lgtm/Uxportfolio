import svgPaths from "./svg-ahxequfe8p";
...
function SystemStar() {
  return (
    <div className="relative shrink-0 size-[36px]" data-name="System / Star">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
        <g id="System / Star">
          <path clipRule="evenodd" d={svgPaths.p25902300} fill="var(--fill-0, #8F8F93)" fillRule="evenodd" id="Icon" />
        </g>
      </svg>
    </div>
  );
